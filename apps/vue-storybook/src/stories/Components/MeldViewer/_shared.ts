/**
 * Shared fixtures for MeldViewer stories.
 *
 ...
 */
import { HIGHLIGHT_COLORS, type MeldAnnotation, type MeldThread } from '@meldui/vue'
...
export const SAMPLE_MARKDOWN = `# MeldViewer
...
> Phase 1 of the MeldViewer change in OpenSpec.
...
\`MeldMarkdownRenderer\` supports, rendered via \`@incremark/vue\`.
 ...
 */
export const SEEDED_ANNOTATIONS: MeldAnnotation[] = [
  {
    id: 'demo-highlight-1',
    type: 'highlight',
    pageIndex: 0,
  ...
  },
  {
    ...
    contents:
      'This is a pre-seeded comment showing the custom doqo-style pin marker rendered by MeldCommentMarker.',
    author: 'Demo User',
    createdAt: new Date().toISOString(),
  },
]

export const SEEDED_THREADS: MeldThread[] = [
  {
...
/** Demo user passed to MeldViewer for comment authorship. */
