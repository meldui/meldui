...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <code>bulkSelectOptions</code>
      </td>
      <td>
        <code>BulkActionOption[]</code>
      </td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>Initial filter values for URL state restoration</td>
    </tr>
    <tr>
      <td>
      ...
      <td>Initial sorting state for URL state restoration</td>
    </tr>
    <tr>
      <td>
        <code>initialPagination</code>
      </td>
      <td>
        <code>Partial&lt;PaginationState&gt;</code>
      </td>
      <td>-</td>
      <td>Initial pagination for URL state restoration (pageIndex, pageSize)</td>
    </tr>
    <tr>
      <td>
        <code>defaultPinning</code>
      </td>
      <td>
        <code>ColumnPinningState</code>
      </td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>Enable column hiding (shows View button in toolbar)</td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <code>columnResizeMode</code>
      </td>
      <td>
        <code>'onChange' | 'onEnd'</code>
      </td>
      <td>
        <code>'onChange'</code>
      </td>
    ...
    <tr>
      ...
      <td>
        <code>'compact' | 'comfortable' | 'spacious'</code>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <code>(row: Row) =&gt; string | Record&lt;string, boolean&gt;</code>
      </td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>
        <code>(row: Row) =&gt; CSSProperties</code>
      </td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>
        <code>(row: Row) =&gt; HTMLAttributes</code>
      </td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>Show "Page X of Y" text indicator</td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <code>enableKeyboardNavigation</code>
      </td>
      <td>
        <code>boolean</code>
      </td>
    ...
    <tr>
      <td>
        <code>filterPlugins</code>
      </td>
      <td>
        <code>RegisteredFilterPlugin[]</code>
      </td>
      <td>
        <code>[]</code>
      </td>
    ...
    <tr>
      ...
      <td>
        Render filter UI inside the toolbar. When <code>true</code>, the DataTable
        instantiates <code>useFilters</code> internally and exposes it via{' '}
        <code>tableRef.value.filtersState</code>. When <code>false</code> (default),
        the parent owns filter state via a separate <code>&lt;Filters&gt;</code>
        component and feeds pre-filtered <code>data</code>.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>-</td>
      <td>Emitted when retry button is clicked in error state</td>
    </tr>
    <tr>
      <td>
        <code>@rowActivate</code>
      </td>
      <td>
        <code>Row&lt;TData&gt;</code>
      </td>
      <td>
        Emitted when Enter is pressed on a focused row (requires{' '}
        <code>enableKeyboardNavigation</code>)
      </td>
    </tr>
  </tbody>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Replace the entire toolbar</td>
    </tr>
    <tr>
      <td>
        <code>#toolbar-start</code>
      </td>
      <td>
        <code>{'{table}'}</code>
      </td>
      <td>Content before search input</td>
    </tr>
    <tr>
      <td>
        <code>#toolbar-end</code>
      </td>
      <td>
        <code>{'{table}'}</code>
      </td>
      <td>Content after bulk actions</td>
    </tr>
    <tr>
      <td>
        <code>#empty</code>
    ...
    <tr>
      ...
      <td>
        <code>{'{error, retry}'}</code>
      </td>
      <td>Custom error state</td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <code>{'{table, pageCount, currentPage, pageSize, canPrevious, canNext}'}</code>
      </td>
      <td>Custom pagination</td>
    </tr>
    <tr>
      <td>
        <code>#row</code>
      ...
      <td>
        <code>{'{row, cells, isSelected, index}'}</code>
      </td>
      <td>Custom row rendering</td>
    </tr>
    <tr>
      <td>
        <code>#cell-[columnId]</code>
      </td>
      <td>
        <code>{'{cell, row, value}'}</code>
      </td>
      <td>Custom cell for specific column</td>
    </tr>
    <tr>
      <td>
        <code>#expanded-row</code>
      </td>
      <td>
        <code>{'{row}'}</code>
      </td>
      <td>
        Content for expanded row (requires <code>enableRowExpansion</code>)
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <code>{'{table, footerGroups}'}</code>
      </td>
      <td>Custom footer content (replaces column footers)</td>
    </tr>
  </tbody>
</table>
...
// Access methods
tableRef.value.filtersState?.resetAll() // when enable-filter="true"; for external <Filters>, call resetAll on your own useFilters
tableRef.value.resetSorting()
tableRef.value.resetSelection()
tableRef.value.resetPagination()
tableRef.value.resetAll() // resets sorting, selection, pagination (filters owned separately)
...
Use `initialFilters`, `initialSorting`, and `initialPagination` to restore table state from URL parameters on page load:

```vue
<script setup>
import { computed } from 'vue'
import { useRoute } from 'vue-router'
import { DataTable, type DataTableFilterState } from '@meldui/vue'
import type { SortingState, PaginationState } from '@tanstack/vue-table'

const route = useRoute()

// URL format: ?page=2&per_page=20&sort_by=name&sort_order=desc&status=active&role=admin

// Parse pagination from URL
const initialPagination = computed<Partial<PaginationState>>(() => ({
  pageIndex: Math.max(0, Number(route.query.page || 1) - 1), // Convert 1-indexed to 0-indexed
...
const initialSorting = computed<SortingState>(() => {
  ...
  return [{
    id: String(route.query.sort_by),
    desc: route.query.sort_order === 'desc',
  }]
})

// Parse filters from URL — keyed by field id, value follows the per-type shape
const initialFilters = computed<DataTableFilterState>(() => {
  const filters: DataTableFilterState = {}
  if (route.query.status) {
    filters.status = [String(route.query.status)] // multiselect → string[]
  }
  if (route.query.role) {
    filters.role = String(route.query.role) // select → string
  }
  return filters
})
</script>
...
**Note:** Reset methods reset to true defaults (empty), not to initial values. This ensures the filter UI reflects the URL state when the page loads, avoiding double API calls.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <code>Ctrl+PageUp</code>
      </td>
      <td>First page</td>
    </tr>
    <tr>
      <td>
        <code>Ctrl+PageDown</code>
      </td>
      <td>Last page</td>
    </tr>
    <tr>
      ...
      <td>
        Toggle row selection (when <code>enableRowSelection</code> is true)
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Activate row (emits <code>@rowActivate</code> event)
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>Clear selection and focus</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <code>aggregations.sum(options)</code>
      </td>
      <td>Sum of all values</td>
      <td>
        <code>format</code>, <code>currency</code>, <code>locale</code>, <code>decimals</code>,{' '}
        <code>prefix</code>, <code>suffix</code>
      </td>
    </tr>
    <tr>
      <td>
        <code>aggregations.count(options)</code>
      </td>
      <td>Count of rows</td>
      <td>
        <code>format</code> (use <code>{'{count}'}</code> placeholder), <code>locale</code>
      </td>
    </tr>
    <tr>
      <td>
        <code>aggregations.average(options)</code>
      </td>
    ...
    <tr>
      <td>
        <code>aggregations.min(options)</code>
      </td>
      <td>Minimum value</td>
      <td>
        <code>format</code>, <code>currency</code>, <code>locale</code>, <code>decimals</code>,{' '}
        <code>dateOptions</code>, <code>prefix</code>, <code>suffix</code>
      </td>
    </tr>
    <tr>
      <td>
        <code>aggregations.max(options)</code>
      </td>
      <td>Maximum value</td>
      <td>
        <code>format</code>, <code>currency</code>, <code>locale</code>, <code>decimals</code>,{' '}
    ...
    <tr>
      <td>
        <code>aggregations.range(options)</code>
      </td>
      <td>Range (min – max)</td>
      <td>
        <code>format</code>, <code>currency</code>, <code>locale</code>, <code>decimals</code>,{' '}
    ...
    <tr>
      <td>
        <code>aggregations.custom(fn)</code>
      </td>
      <td>Custom aggregation</td>
      <td>
        Function receiving <code>{'{table, column}'}</code> context
      </td>
    </tr>
  </tbody>
</table>
...
The DataTable uses your theme's CSS custom properties directly for consistent styling. Colors, borders, and states automatically adapt to your theme.

### Theme Variables Used

The DataTable references these standard theme variables:

- `--background`, `--foreground` - Base colors
- `--muted`, `--muted-foreground` - Header and footer backgrounds
- `--accent` - Hover states
- `--border` - All borders
...
Control cell padding and font size with the `density` prop:
...
The density system uses these CSS variables (customizable per density level):
...
Use the `rowClass`, `rowStyle`, and `rowProps` props for dynamic row styling:
...
```vue
<template>
  <DataTable class="striped-table" ... />
</template>

<style>
.striped-table :deep(tbody tr:nth-child(even) td) {
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <code>helper.accessor(key, options)</code>
      </td>
      <td>Creates an accessor column with auto-generated header</td>
    </tr>
    <tr>
      <td>
        <code>helper.display(options)</code>
      </td>
      <td>Creates a display column (no data accessor)</td>
    </tr>
    <tr>
      <td>
        <code>helper.selection(options?)</code>
      </td>
      <td>Creates a selection checkbox column</td>
    </tr>
    <tr>
      <td>
        <code>helper.expander(options?)</code>
      </td>
      <td>Creates an expander toggle column for row expansion</td>
    </tr>
    <tr>
      <td>
        <code>helper.actions(options)</code>
      </td>
      <td>Creates an actions column (inline or dropdown)</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <code>cellRenderers.badge(options)</code>
      </td>
      <td>Renders a Badge component</td>
      <td>
        <code>variantMap</code>, <code>defaultVariant</code>, <code>format</code>
      </td>
    </tr>
    <tr>
      <td>
        <code>cellRenderers.date(options)</code>
      </td>
      <td>Formats date values</td>
      <td>
        <code>format</code>, <code>locale</code>, <code>fallback</code>
      </td>
    </tr>
    <tr>
      <td>
        <code>cellRenderers.currency(options)</code>
      </td>
      <td>Formats as currency</td>
      <td>
        <code>currency</code>, <code>locale</code>, <code>minimumFractionDigits</code>
      </td>
    </tr>
    <tr>
      <td>
        <code>cellRenderers.number(options)</code>
      </td>
      <td>Formats numbers</td>
      <td>
        <code>locale</code>, <code>useGrouping</code>, <code>compact</code>
      </td>
    </tr>
    <tr>
      <td>
        <code>cellRenderers.boolean(options)</code>
      </td>
      <td>Formats boolean values</td>
      <td>
        <code>trueText</code>, <code>falseText</code>, <code>asBadge</code>
      </td>
    </tr>
    <tr>
      <td>
        <code>cellRenderers.truncate(maxLength)</code>
      </td>
      <td>Truncates text with ellipsis</td>
      <td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Unique filter type identifier</td>
    </tr>
    <tr>
      <td>
        <code>component</code>
      ...
      <td>Vue component that renders the filter</td>
    </tr>
    <tr>
      <td>
        <code>operators</code>
      ...
      <td>Available operators (optional)</td>
    </tr>
    <tr>
      <td>
        <code>defaultOperator</code>
      </td>
      <td>
        <code>FilterOperator</code>
      </td>
      <td>Default operator (optional)</td>
    </tr>
    <tr>
      <td>
        <code>supportsMultiInstance</code>
      </td>
      <td>
        <code>boolean</code>
      </td>
      <td>Allow multiple instances (default: false)</td>
    </tr>
    <tr>
      <td>
        <code>serialize</code>
      ...
      <td>Transform value for server (optional)</td>
    </tr>
    <tr>
      <td>
      ...
      <td>Transform server value back (optional)</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>The table column being filtered</td>
    </tr>
    <tr>
      <td>
        <code>title</code>
    ...
    <tr>
      ...
      <td>Auto-open on mount</td>
    </tr>
    <tr>
      <td>
        <code>openTrigger</code>
      </td>
      <td>
        <code>number</code>
      </td>
      <td>Trigger to re-open</td>
    </tr>
    <tr>
      <td>
        <code>advancedMode</code>
      ...
      <td>Whether advanced mode is enabled</td>
    </tr>
    <tr>
      <td>
        <code>defaultOperator</code>
    ...
    <tr>
      ...
      <td>Custom props from filter field</td>
    </tr>
  </tbody>
</table>
