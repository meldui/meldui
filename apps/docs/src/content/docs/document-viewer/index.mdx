...
description: A reusable Vue composite for viewing and annotating PDF, image, plain-text, and markdown documents — built on EmbedPDF (PDFium WASM) with a single feature opt-in surface.
category: composites
order: 1
package: '@meldui/vue'
componentName: DocumentViewer
previewDemo: BasicPdfDemo
---
