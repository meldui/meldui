...
import { allTasks, deleteTask, deleteTasks, updateTasksStatus } from '@/stores/tasks'
...
function simulateServerSide(data: Task[], tableState: TableState): ServerResponse {
...
const columns: ColumnDef<Task, unknown>[] = [
  ...
  },
  {
    ...
    cell: ({ row }: CellContext<Task, unknown>) => {
      ...
      return h(Badge, { variant: getStatusBadgeVariant(status), outline: true }, () =>
    ...
    <div class="flex items-center justify-between">
      ...
      <Dialog v-model:open="isCreateDialogOpen">
        ...
        <DialogContent class="sm:max-w-[600px]">
          ...
          <TaskForm @submit="handleTaskCreated" @cancel="isCreateDialogOpen = false" />
        </DialogContent>
      </Dialog>
    </div>
