...
<template>
  <div
    class="min-w-48 max-h-64 overflow-y-auto rounded-lg border border-border bg-popover p-1 shadow-lg"
  >
    <!-- Loading -->
    ...
    <!-- Empty -->
    <div v-else class="px-3 py-3 text-sm text-muted-foreground">No results found</div>
  </div>
</template>
