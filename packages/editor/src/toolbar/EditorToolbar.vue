...
<template>
  <div
    class="flex flex-wrap items-center gap-1 border-b border-border bg-muted/50 px-3 py-2 rounded-t-lg"
  >
        ...
        <Tooltip>
          ...
          <TooltipContent side="bottom" :side-offset="4">
            <p class="flex items-center gap-2">
              {{ item.label }}
              <kbd v-if="item.shortcut" class="text-xs text-muted-foreground">{{
                item.shortcut
              }}</kbd>
            </p>
          </TooltipContent>
