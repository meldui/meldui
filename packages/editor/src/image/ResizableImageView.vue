...
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@meldui/vue'
import {
  IconAlignLeft,
  IconAlignCenter,
  IconAlignRight,
...
<template>
  <NodeViewWrapper class="flex w-full py-4" :style="{ justifyContent: wrapperJustify }">
    <div
      ref="containerRef"
      ...
      >
        <TooltipProvider :delay-duration="400">
          ...
          >
            <Tooltip>
              <TooltipTrigger as-child>
                ...
                >
                  <component :is="a.icon" :size="16" :stroke="1.5" />
                </button>
              </TooltipTrigger>
              <TooltipContent side="top" :side-offset="8" class="z-[999]">{{
                a.label
              }}</TooltipContent>
            </Tooltip>
          </template>
          ...
          <Tooltip>
            ...
            <TooltipContent side="top" :side-offset="8">Caption</TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger as-child>
              <button
            ...
            <TooltipContent side="top" :side-offset="8">Download</TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger as-child>
              <button
            ...
            <TooltipContent side="top" :side-offset="8">Replace image</TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger as-child>
              <button
