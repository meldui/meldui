/**
 * useTextSearch — DOM-based search highlighting for the text and
 ...
 * `DocumentViewer` can dispatch search calls to whichever renderer is active
...
export function useTextSearch(contentRef: Ref<HTMLElement | null>): UseTextSearchReturn {
  const query = ref('')
