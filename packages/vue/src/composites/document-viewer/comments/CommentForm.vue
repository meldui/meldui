...
/**
 * CommentForm — single-modal comment composer anchored to a page click.
 *
 * Ported from doqo's `CommentForm.vue`. The form is rendered absolute over
 * the page; the host (DocumentViewer) computes the click coord in page-local
...
<template>
  <div
    class="comment-form absolute z-30 rounded-md border border-border bg-popover p-2 text-popover-foreground shadow-lg"
    :style="formStyle"
    role="dialog"
