...
/**
 * CommentMarker — custom renderer for sticky-note annotations.
 *
 ...
 * `useRegisterRenderers([...])` in PdfViewer.
 *
...
/**
 * Reply-count metadata is provided by DocumentViewer (the host) via provide/
  ...
  <TooltipProvider :delay-duration="120">
    <Tooltip>
      <TooltipTrigger as-child>
        <div
          class="comment-marker pointer-events-auto absolute inset-0 flex items-start justify-start"
