...
/**
 * MeldThumbnailsPanel — sidebar of page thumbnails backed by EmbedPDF's
 * `ThumbnailsPane` (handles windowing / lazy rendering automatically).
 *
 * Lives inside the `<EmbedPDF>` tree (mounted by MeldPdfRenderer).
 *
...
<template>
  <div class="meld-thumbnails-panel relative h-full overflow-hidden">
