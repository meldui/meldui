/**
 * useMeldTouch — viewer touch gesture composable.
 *
...
export interface MeldTouchHandlers {
  onSwipeLeft?: () => void
  onSwipeRight?: () => void
  onDoubleTap?: () => void
}

export interface MeldTouchOptions {
...
export function useMeldTouch(
  elementRef: Ref<HTMLElement | null>,
  handlers: MeldTouchHandlers,
  options: MeldTouchOptions = {},
) {
  let lastTapTime = 0
  let startX = 0
  let startY = 0
