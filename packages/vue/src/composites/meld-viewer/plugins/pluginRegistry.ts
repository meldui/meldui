...
import type { DocumentSource, MeldViewerFeatureConfig, MeldViewerFeatures } from '../types'

/** Default feature flags — sensible defaults for a typical PDF viewer. */
export const DEFAULT_FEATURES: Required<MeldViewerFeatures> = {
  zoom: true,
  rotate: true,
  spread: false,
  pan: true,
...
export function buildPlugins({
  ...
  // File/Blob/ArrayBuffer sources are loaded imperatively by MeldPdfRenderer
